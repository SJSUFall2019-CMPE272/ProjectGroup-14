...
import medi_logo from "../../images/medi-logo.png";
    ...
    render() {
        return <div className='Modal'>
            ...
            <div className='social-signin'>
                ...
                <button className="tw" onClick={this.props.onClick}><i className="fa fa-twitter" aria-hidden="true"></i>
                </button>
            </div>
...
class Logo extends React.Component {
    render() {
        return <div className="logo">
            ...
            <img className="account-logo" src={medi_logo} alt="Quora"/>
        </div>
    }
}
